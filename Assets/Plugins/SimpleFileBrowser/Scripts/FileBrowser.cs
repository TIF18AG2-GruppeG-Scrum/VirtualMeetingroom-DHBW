...
#pragma warning disable 0649
		...
		private static Dictionary<string, Sprite> filetypeToIcon = new Dictionary<string, Sprite>();
...
#pragma warning restore 0649
        ...
        public static void AddExtension(string extension,Sprite icon)
        {
            filetypeToIcon[extension] = icon;
        }
